...
android {
    ...
    buildTypes {
        release {
            // A local key.properties file is intentionally excluded from Git.
            // Without it, Gradle creates an unsigned release instead of ever
            // falling back to the insecure debug key.
